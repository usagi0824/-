...
# App
# =========================================================
APP_TITLE = "智跃 AI｜高阶思维能力测评"
APP_SUBTITLE = "看见你的思维方式，而不只是一个分数"
...
if st.session_state.stage == "intro":
    st.markdown(
        f"""
        <div class="hero">
            <div class="brand-pill">✦ AI × THINKING</div>
...
# =========================================================
    ...
    st.markdown(
        ...
        <div class="survey-top">
            <div class="survey-title">✦ 智跃 AI · 思维测评</div>
...
# =========================================================
    ...
    st.markdown(
        f"""
        <div class="soft-panel">
            <strong>第 1–2 天｜{DIMENSION_INFO[d1]["icon"]} 聚焦 {escape(d1)}</strong><br>
            从上面的建议中选择 1 个动作，在一次真实学习任务中实践。<br><br>

            <strong>第 3–4 天｜{DIMENSION_INFO[d2]["icon"]} 聚焦 {escape(d2)}</strong><br>
